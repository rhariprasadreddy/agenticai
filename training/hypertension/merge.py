#!/usr/bin/env python3
# Merge HTN LoRA adapters into a full FP16 Qwen2.5 model
...
OUT_DIR = os.getenv(
    "HTN_MERGED_DIR",
    "/workspace/models/hypertension_qwen_merged_fp16",
)
...
assert Path(LORA_DIR, "adapter_config.json").is_file() or \
       Path(LORA_DIR, "adapter_config.json").exists(), \
       f"❌ No adapter config in {LORA_DIR}"
...
print("✅ Done. Merged HTN Qwen model at:", OUT_DIR)
